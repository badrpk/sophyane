"""Historical executable-task compiler compatibility boundary.

This module preserves the last known executable task contract used by task_orchestrator, task_execution and task_validation.

It is intentionally separate from the newer generic D4/D5 task compiler.
"""
